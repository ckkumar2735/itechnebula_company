...
<body>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-6">
          ...
          <!-- <form method="post" action="" enctype="multipart/form-data">
              ...
              <div class="mt-5">
                <select style="border: 2px solid #5454AC; height: 60px; " class="form-select onlyback mx-auto" id="city" name="city" aria-describedby="validationServer05Feedback" required>
                  <option selected disabled value="">Select your area * </option>
                  ...
                  <option value="Musahri"> Musahri</option>
                ...
                <p class="error" id="city-error" style="color: red; display: none;">Please select a city.
                </p>
              </div>
  ...
  <script>
    ...
    // Attach an event listener to record exit time when the user leaves the page
    window.addEventListener("beforeunload", function() {
      var exitTime = new Date().getTime();
      var timeSpent = Math.floor((exitTime - entryTime) / 1000); // Convert to seconds

      // Send an AJAX request to update the time_spent in the database
      var xhr = new XMLHttpRequest();
      xhr.open("GET", "update_time_spent.php?last_id=<?php echo $_SESSION['last_id']; ?>&time_spent=" + timeSpent, true);
      xhr.send();
    });
  </script>
