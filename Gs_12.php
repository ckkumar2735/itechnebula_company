...
<head>
  ...
  <link rel="stylesheet" href="Styles/Gs/Gs_12.css" />
      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-lg-8">
              <h1 class="ck_gs_12_text1">Do you have a budget in mind for this project?
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-7 mt-5 mx-auto">
              <input type="text" placeholder="₹0" alt="" class="ck_gs_12_input1 text-center" readonly>
            </div>
          </div>
