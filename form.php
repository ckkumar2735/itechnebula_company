                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto rjj-nev">
                                <li class="nav-item mx-3">
                                    <a class="nav-link  home-rjj" aria-current="page" href="#">Home</a>
                                </li>
                                <li class="nav-item mx-3">
                                    <a class="nav-link home-rjj" href="#">Case studies</a>
                                </li>
                                ...
                                <li class="nav-item mx-3">
                                    <a class="nav-link home-rjj" href="#" tabindex="-1" aria-disabled="true">
                    ...
                    <!-- <form action="send_email1.php" class="row g-3" id="logfrm" method="POST" enctype="multipart/form-data"> -->
                        ...
                        <div class="row d-flex justify-content-between">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <p class="error" id="city-error" style="color: red; display: none;">Please select a
                                    city.
                                </p>
                            </div>
                            <div class="col-md-6 col-sm-12">
        ...
        <div class="container ">
            ...
            <footer class=" text-lg-start ">
                ...
                <div class="container p-4 pb-0">
                    ...
                    <section class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-6 mb-4 mb-md-0 ft-rjj">
                                ...
                                <h5 class="text-rjj">Empowering Your Digital Journey with
                                    ...
                                    <span class="ck_textsec8_122">इटेकनेब्यूला</span> Navigating the Future with
                                    Confidence
                                </h5>
                            ...
                            <div class="col-lg-2 col-md-6 mb-4 mb-md-0 ft2-rjj">
                                ...
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li>
                                        <a href="career.html" class="text-inner">Careers</a>
                                    </li>
                                    <li>
                                        <a href="#!" class="text-inner">Contact us</a>
                                    </li>
                                    <!-- <li>
                      <a href="#!" class="text-white">Link 4</a>
                            ...
                            <div class="col-lg-3 col-md-6 mb-4 mb-md-0 ft2-rjj">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li>
                                        <a href="Website Development Services.html" class="text-inner">Web Development
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#!" class="text-inner">SEO & Performance Marketing</a>
                                    </li>
                                    <li>
                                        <a href="WRS.html" class="text-inner">Website Redesign</a>
                                    </li>
                                    <li>
                                        <a href="#!" class="text-inner">Mobile app Development</a>
                                    </li>
                                </ul>
                            </div>
                            <!--Grid column-->
                            ...
                            <div class="col-lg-1 col-md-6 mb-4 mb-md-0 ft2-rjj">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li>
                                        <a href="#!" class="text-inner">Courses</a>
                                    </li>
                                    <li>
                                        <a href="Agency.html" class="text-inner">Agency</a>
                                    </li>
                                    <li>
                                        <a href="#!" class="text-inner">Partnership </a>
                                    </li>
                                    <!-- <li>
                      <a href="#!" class="text-white">Link 4</a>
                    </li> -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <p class="rjj_pr"> It is protected by all possible laws. You're gonna get your family in
                                trouble if you
                                try to copy. In the style of Liam Neeson. Term & Conditions | Privacy & Policy
