...
<head>
  ...
  <link rel="stylesheet" href="Styles/Gs/Gs_10.css" />
      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_10_text1">Can you describe the current challenges or issues you're facing with your existing IT infrastructure?
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-7 mt-5">
              <input type="text" placeholder="MESSAGE" alt="" class="ck_gs_10_input1 mx-2 text-center" />
            </div>
          </div>

          <div class="row">
            <div class="mt-5 ">
              <a href="Gs_11.php"><button class="ck_gs_10_btn"> Continue <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
