...
<head>
  ...
  <link rel="stylesheet" href="Styles/Gs/Gs_11.css" />
      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_11_text1">What specific functionalities or features are essential for your organization in this solution?
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-7 mt-5">
              <input type="text" placeholder="MESSAGE" alt="" class="ck_gs_11_input1 mx-2 text-center" />
            </div>
          </div>

          <div class="row">
            <div class="mt-5 ">
              <a href="Gs_12.php"><button class="ck_gs_11_btn"> Continue <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
